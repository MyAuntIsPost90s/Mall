...
public class OrderFormServiceImpl implements OrderFormService {
    ...
    public EUIPageList<Orderform> list(Orderform orderform, int page, int rows) {
        PageList<Orderform> pageList = QueryPageListProxy.query(() -> orderformMapper.getList(orderform), page, rows);
        return new EUIPageList<Orderform>(pageList.getTotal(), pageList.getRows());
    }
    ...
    public EUIPageList<OrderWithGoodsDto> orderWithGoods(Orderform orderform, int page, int rows) {
        ...
        for (Orderform item : pageList.getRows()) {
